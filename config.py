...
#VEHICLE
DRIVE_LOOP_HZ = 2      # the vehicle loop will pause if faster than this speed.
...
DRIVE_TRAIN_TYPE = "WIRELESS" # SERVO_ESC|DC_STEER_THROTTLE|DC_TWO_WHEEL|SERVO_HBRIDGE_PWM
